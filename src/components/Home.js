            ...
            <div className="back">
                ...
                <div class="box title">
                    <div className="container-fluid solid">
                        <ul className="links">
                            <li onClick={() => window.open("https://leetcode.com/u/kaal_01/", "_blank")}>
                                <i>
                                    <SiLeetcode className="text-success" />
                                </i>
                            </li>
                            <li onClick={() => window.open("https://www.linkedin.com/in/piyush-anand-622a16264/", "_blank")}>
                                <i>
                                    <LinkedIn className="text-success" />
                                </i>
                            </li>
                        </ul>
